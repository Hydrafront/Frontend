...
export default function Roadmap() {
    return (
        <div className="pt-[80px] px-[2.2vw] lg-max:px-[4.3vw]">
                ...
                <div className="flex text-white">
                    <div className="w-1/2">
                        ...
                        <div className="relative">
                            <h2 className="pl-4 py-2 inline-block">Roadmap</h2>
            ...
            <ContainerSmall className="block md:flex">
                <div className="w-full border-y border-borderColor flex flex-col">
                    <div className="flex">
                        ...
                        <p className="border border-white px-8 flex items-center text-lg">IN PROGRESS</p>
                    </div>
                    <div className="px-8 py-6 text-xl text-white border-b border-borderColor">
                        2024-2025 INITIATIVE
                    </div>
                    <div className="p-8 h-full text-lg grid content-between">
                        <div>
                ...
                <div className="w-full border-y border-borderColor flex flex-col">
                    ...
                    <div className="p-8 h-full text-lg grid content-between">
                        <div>
                            <div className="text-white mb-4 flex items-start gap-4">
                                <img width="5" height="6" alt="" src="https://cdn.prod.website-files.com/64354b8ce4872ad8cd1c7b04/6436bdb39b7ca6101e1a307d_ico-indicator-light.svg" loading="lazy" className="rotate-180 my-2 opacity-60" />
                                <p>Decentralized Exchange (Under development)</p>
                            </div>
                            <div className="text-white mb-4 flex items-start gap-4">
                                <img width="5" height="6" alt="" src="https://cdn.prod.website-files.com/64354b8ce4872ad8cd1c7b04/6436bdb39b7ca6101e1a307d_ico-indicator-light.svg" loading="lazy" className="rotate-180 my-2 opacity-60" />
                                <p>Governance App.</p>
